...
Per maggiori informazioni vedere https://docs.aws.amazon.com/AmazonS3/latest/API/API_SelectObjectContent.html["Riferimento API di Amazon Simple Storage Service: SelectObjectContent"^] .
