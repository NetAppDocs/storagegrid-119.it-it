...
NOTE: Sebbene il servizio StorageGRID Load Balancer sia il meccanismo di bilanciamento del carico consigliato, potresti voler integrare un bilanciatore di carico di terze parti. Per informazioni, contatta il tuo NetApp account representative o consulta  https://docs.netapp.com/us-en/storagegrid-enable/technical-reports/load-balancer-index.html["Utilizza bilanciatori di carico di terze parti con StorageGRID"^].
