...
summary: È possibile utilizzare i file di esempio per aggregare quattro interfacce fisiche Linux in un singolo legame LACP e quindi stabilire tre interfacce VLAN che sottendono il legame da utilizzare come interfacce StorageGRID Grid, Admin e Client Network. 
---
...
[role="lead"]
È possibile utilizzare i file di esempio per aggregare quattro interfacce fisiche Linux in un singolo legame LACP e quindi stabilire tre interfacce VLAN che sottendono il legame da utilizzare come interfacce StorageGRID Grid, Admin e Client Network.
